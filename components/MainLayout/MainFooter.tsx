...
export const MainFooter: FC = () => {
  return (
    <footer className="bg-slate-200 rounded-lg shadow dark:bg-gray-900 m-4 border border-slate-300">
      <div className="w-full max-w-screen-xl mx-auto p-2 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <a href="/" className="flex items-center mb-4 sm:mb-0">
            <svg
              className="w-6 h-8 mr-3 text-gray-800 dark:text-white"
              aria-hidden="true"
