export const PensionEstimatorGraphPlaceholderView = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center my-4 gap-4 bg-white p-4">
      ...
      <div className=" w-full grow-1 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 bg-slate-700 flex gap-4 items-center justify-start">
        <svg
        ...
        <blockquote className="text-sm italic font-semibold text-white dark:text-white">
          <p>
      ...
      <div className=" w-full  grow-1 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 bg-violet-500 justify-start flex gap-4">
        <svg
          className="w-6 h-6 text-white dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className=" w-full  grow-1 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 bg-red-400 flex gap-4">
        <svg
          className="w-6 h-6 text-white dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
